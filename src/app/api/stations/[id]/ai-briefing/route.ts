...
- 오늘 국제유가에 가장 큰 영향을 주는 속보 1건을 검색하세요. 반드시 다음 형식으로만 작성:
  [뉴스] 헤드라인 한 줄 (20자 이내)
  [영향] 실시간 유가 영향 한 줄 (예: Brent $95.8, 전일 대비 -$3.2 하락 중. 추가 하락 예상.)
  예시:
  [뉴스] 이란-미국 2주 휴전 합의
  [영향] Brent $95.8, 전일 대비 -$3.2 하락 중. 추가 하락 예상.
  예시:
  [뉴스] OPEC+ 감산 100만배럴 연장
  [영향] Brent $102.3, 전일 대비 +$2.1 상승. 소매가 인상 압력.
  이 2줄 외에 뉴스에 대한 추가 설명을 절대 쓰지 마세요.
  중대 뉴스가 없으면 [뉴스] [영향] 태그 자체를 생략하세요.
