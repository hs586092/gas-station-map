...
- 유가 관련 최신 뉴스를 검색하되, 결과는 반드시 한 줄(30자 이내)로 요약하세요
- 형식: "[뉴스] 헤드라인 → 영향" (예: "[뉴스] 호르무즈 해협 2주 휴전 합의 → 유가 급락 예상", "[뉴스] OPEC+ 감산 연장 합의 → 유가 상승 지속")
- 뉴스에 대한 상세 설명이나 배경은 쓰지 마세요. 헤드라인 한 줄만.
- 유가에 영향을 주는 중대 뉴스가 없으면 [뉴스] 태그 자체를 생략하세요
