              ...
              {sd.avgFuelCount && sd.avgCarwashCount && (
                <div className="rounded-lg bg-purple-50 border border-purple-200 p-4 mb-4">
                  <div className="text-[13px] font-bold text-purple-700">
                    ...
                    <span className={`ml-2 text-[11px] px-1.5 py-0.5 rounded-full ${sd.confidence === "high" ? "bg-emerald-100 text-emerald-700" : sd.confidence === "medium" ? "bg-amber-100 text-amber-700" : "bg-slate-100 text-slate-600"}`}>
